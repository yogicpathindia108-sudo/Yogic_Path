...
class DSM_Button extends ET_Builder_Module {
	...
	public function init() {
		$this->name             = esc_html__( 'Supreme Button', 'supreme-modules-for-divi' );
		$this->plural           = esc_html__( 'Supreme Buttons', 'supreme-modules-for-divi' );
		$this->icon_path        = plugin_dir_path( __FILE__ ) . 'icon.svg';
		$this->main_css_element = '%%order_class%%';

		$this->custom_css_fields = array(
			'main_element' => array(
				'label'                    => esc_html__( 'Main Element', 'supreme-modules-for-divi' ),
					...
					'links'        => array(
						'sub_toggles'       => array(
							'button_one_tab' => array(
								'name' => esc_html__( 'Button #1', 'supreme-modules-for-divi' ),
							),
							'button_two_tab' => array(
								'name' => esc_html__( 'Button #2', 'supreme-modules-for-divi' ),
							),
						),
						'tabbed_subtoggles' => true,
						'title'             => esc_html__( 'Links', 'supreme-modules-for-divi' ),
					),
					'separator'    => esc_html__( 'Separator', 'supreme-modules-for-divi' ),
				),
			),
			'advanced' => array(
				'toggles' => array(
					'alignment' => esc_html__( 'Alignment', 'supreme-modules-for-divi' ),
					'text'      => array(
					...
					'lightbox'  => array(
						...
						'tabbed_subtoggles' => true,
						'title'             => esc_html__( 'Lightbox', 'supreme-modules-for-divi' ),
					),
					'tooltip'   => array(
						'sub_toggles'       => array(
							'button_one_tab' => array(
								'name' => esc_html__( 'Tooltip #1', 'supreme-modules-for-divi' ),
							),
							'button_two_tab' => array(
								'name' => esc_html__( 'Tooltip #2', 'supreme-modules-for-divi' ),
							),
						),
						'tabbed_subtoggles' => true,
						'title'             => esc_html__( 'Tooltip Text', 'supreme-modules-for-divi' ),
						'priority'          => 60,
					),
				),
			),
		...
		return array(
			'fonts'          => array(
				'separator_text' => array(
					'label'          => esc_html__( 'Separator', 'supreme-modules-for-divi' ),
					'css'            => array(
				...
				'tooltip_one'    => array(
					'label'           => esc_html__( 'Tooltip #1', 'supreme-modules-for-divi' ),
					'css'             => array(
				...
				'tooltip_two'    => array(
					'label'           => esc_html__( 'Tooltip #2', 'supreme-modules-for-divi' ),
					'css'             => array(
			...
			'button'         => array(
				'button_one' => array(
					'label'          => esc_html__( 'Button One', 'supreme-modules-for-divi' ),
					'css'            => array(
				...
				'button_two' => array(
					'label'          => esc_html__( 'Button Two', 'supreme-modules-for-divi' ),
					'css'            => array(
	...
	public function get_fields() {
		$dsm_animation_type_list = array(
			...
			'fade-in-direction' => esc_html__( 'Fade In Direction', 'supreme-modules-for-divi' ),
		);
		return array(
			'button_one_id'                      => array(
				'label'           => esc_html__( 'Button #1 ID', 'supreme-modules-for-divi' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'description'     => esc_html__( "Assign a unique CSS ID to Button #1 which can be used to assign custom CSS styles from within your child theme or from within Divi's custom CSS inputs.", 'supreme-modules-for-divi' ),
				'tab_slug'        => 'custom_css',
				'toggle_slug'     => 'classes',
				'option_class'    => 'et_pb_custom_css_regular',
			),
			'button_one_css'                     => array(
				'label'           => esc_html__( 'Button #1 CSS Class', 'supreme-modules-for-divi' ),
				'type'            => 'text',
				'option_category' => 'configuration',
			...
			'button_two_id'                      => array(
				'label'           => esc_html__( 'Button #2 ID', 'supreme-modules-for-divi' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'description'     => esc_html__( "Assign a unique CSS ID to Button #2 which can be used to assign custom CSS styles from within your child theme or from within Divi's custom CSS inputs.", 'supreme-modules-for-divi' ),
				'tab_slug'        => 'custom_css',
				'toggle_slug'     => 'classes',
				'option_class'    => 'et_pb_custom_css_regular',
			),
			'button_two_css'                     => array(
				'label'           => esc_html__( 'Button #2 CSS Class', 'supreme-modules-for-divi' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'description'     => esc_html__( "Assign any number of CSS Classes to the element, separated by spaces, which can be used to assign custom CSS styles from within your child theme or from within Divi's custom CSS inputs.", 'supreme-modules-for-divi' ),
				'tab_slug'        => 'custom_css',
			...
			'button_one_text'                    => array(
				'label'           => esc_html__( 'Button #1 Text', 'supreme-modules-for-divi' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Enter the text for the Button.', 'supreme-modules-for-divi' ),
				'toggle_slug'     => 'main_content',
				'dynamic_content' => 'text',
			),
			'button_one_url_type'                => array(
				'label'            => esc_html__( 'Link Type for Button #1', 'supreme-modules-for-divi' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => array(
					'url'          => esc_html__( 'URL Link', 'supreme-modules-for-divi' ),
					'download'     => esc_html__( 'Download File', 'supreme-modules-for-divi' ),
					'email'        => esc_html__( 'Email', 'supreme-modules-for-divi' ),
					'phone'        => esc_html__( 'Phone', 'supreme-modules-for-divi' ),
					'sms'          => esc_html__( 'SMS', 'supreme-modules-for-divi' ),
					'fb_messenger' => esc_html__( 'Facebook Messenger', 'supreme-modules-for-divi' ),
					'skype'        => esc_html__( 'Skype', 'supreme-modules-for-divi' ),
					'whatsapp'     => esc_html__( 'WhatsApp', 'supreme-modules-for-divi' ),
					'telegram'     => esc_html__( 'Telegram', 'supreme-modules-for-divi' ),
				),
				'description'      => esc_html__( 'Choose the type of URL', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'default_on_front' => 'url',
			),
			'button_one_email_address'           => array(
				'label'            => esc_html__( 'Email', 'supreme-modules-for-divi' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the Email Address for Button #1.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_one_email_cc'                => array(
				'label'            => esc_html__( 'CC', 'supreme-modules-for-divi' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the carbon copy email address for Button #1.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_one_email_bcc'               => array(
				'label'            => esc_html__( 'BCC', 'supreme-modules-for-divi' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the blind carbon copy email address for Button #1.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_one_email_subject'           => array(
				'label'           => esc_html__( 'Subject', 'supreme-modules-for-divi' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Enter the default subject of the email for Button #1.', 'supreme-modules-for-divi' ),
				'toggle_slug'     => 'links',
				'sub_toggle'      => 'button_one_tab',
				'show_if'         => array(
					'button_one_url_type' => 'email',
			...
			'button_one_email_msg'               => array(
				'label'            => esc_html__( 'Message', 'supreme-modules-for-divi' ),
				'type'             => 'textarea',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the default body message of the email for Button #1.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_one_phone_number'            => array(
				'label'            => esc_html__( 'Phone Number', 'supreme-modules-for-divi' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the phone number to call for Button #1 (This will usually work on mobile phones)', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_one_sms_number'              => array(
				...
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the phone number to SMS for Button #1 (This will usually work on mobile phones)', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_one_sms_body_text'           => array(
				'label'            => esc_html__( 'Body Text', 'supreme-modules-for-divi' ),
				'type'             => 'textarea',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Pre-Populate SMS Text for Button #1 (This will usually work on mobile phones)', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_one_fb_messenger'            => array(
				'label'            => esc_html__( 'Username', 'supreme-modules-for-divi' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter a person, page, or bot username.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_one_skype'                   => array(
				...
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the Skype username for Button #1.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_one_skype_action_type'       => array(
				'label'            => esc_html__( 'Action Type', 'supreme-modules-for-divi' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => array(
					'chat' => esc_html__( 'Chat', 'supreme-modules-for-divi' ),
					'call' => esc_html__( 'Call', 'supreme-modules-for-divi' ),
					/*
					'userinfo'  => esc_html__( 'Show Skype Profile', 'supreme-modules-for-divi' ),
					'sendfile'  => esc_html__( 'Send a File', 'supreme-modules-for-divi' ),
					'add'  => esc_html__( 'Add', 'supreme-modules-for-divi' ),
					'voicemail'  => esc_html__( 'Voicemail', 'supreme-modules-for-divi' ),
					*/
				),
				'description'      => esc_html__( 'Choose the action type for Skype', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
			...
			'button_one_whatsapp_number'         => array(
				'label'            => esc_html__( 'Number', 'supreme-modules-for-divi' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the phone number to message directly via WhatsApp message for Button #1.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_one_whatsapp_msg'            => array(
				...
				'type'             => 'textarea',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the default body message of the WhatsApp for Button #1.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_one_telegram'                => array(
				'label'            => esc_html__( 'Telegram Username', 'supreme-modules-for-divi' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the Telegram Username.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_one_telegram_msg'            => array(
				...
				'type'             => 'textarea',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the default body message of the Telegram for Button #1.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_one_url'                     => array(
				'label'           => esc_html__( 'Button #1 URL', 'supreme-modules-for-divi' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Enter the URL for the Button.', 'supreme-modules-for-divi' ),
				'toggle_slug'     => 'links',
				'sub_toggle'      => 'button_one_tab',
				'show_if'         => array(
			...
			'button_one_download_file'           => array(
				'label'              => esc_html__( 'Download File', 'supreme-modules-for-divi' ),
				'type'               => 'upload',
				'option_category'    => 'basic_option',
				'data_type'          => '',
				'upload_button_text' => esc_attr__( 'Upload a file', 'supreme-modules-for-divi' ),
				'choose_text'        => esc_attr__( 'Choose a file', 'supreme-modules-for-divi' ),
				'update_text'        => esc_attr__( 'Set As Download File', 'supreme-modules-for-divi' ),
				'toggle_slug'        => 'links',
				'sub_toggle'         => 'button_one_tab',
				'show_if'            => array(
			...
			'button_one_image_popup'             => array(
				'label'            => esc_html__( 'Open as Image Lightbox', 'supreme-modules-for-divi' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
				...
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'description'      => esc_html__( 'Here you can choose whether or not the button should open in Lightbox. Note: if you select to open the button in Lightbox, url options below will be ignored.', 'supreme-modules-for-divi' ),
				'default_on_front' => 'off',
				'show_if'          => array(
					'button_one_url_type' => 'url',
				),
			...
			'button_one_image_src'               => array(
				...
				'hide_metadata'      => true,
				'description'        => esc_html__( 'Upload your desired image for Button One Image Lightbox, or type in the URL to the image you would like to display.', 'supreme-modules-for-divi' ),
				'toggle_slug'        => 'links',
				'sub_toggle'         => 'button_one_tab',
				'show_if'            => array(
					'button_one_url_type'    => 'url',
			...
			'button_one_lightbox_close_color'    => array(
				'label'        => esc_html__( 'Close Color', 'supreme-modules-for-divi' ),
				'description'  => esc_html__( 'Here you can define a custom color for the lightbox close button.', 'supreme-modules-for-divi' ),
				'type'         => 'color-alpha',
				'custom_color' => true,
			...
			'button_one_lightbox_max_width'      => array(
				'label'          => esc_html__( 'Max Width', 'supreme-modules-for-divi' ),
				'description'    => esc_html__( 'Setting a maximum width will prevent your lightbox from ever surpassing the defined width value. Maximum width can be used in combination with the standard width setting. Maximum width supersedes the normal width value.', 'supreme-modules-for-divi' ),
				'type'           => 'range',
				'default'        => 'none',
				'default_tablet' => 'none',
				'default_unit'   => 'px',
			...
			'button_one_video_popup'             => array(
				'label'            => esc_html__( 'Open as Video Lightbox', 'supreme-modules-for-divi' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
					'off' => esc_html__( 'No', 'supreme-modules-for-divi' ),
				...
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'description'      => esc_html__( 'Put the Video link on the Button #1 URL. Copy the video URL link and paste it here. Support: YouTube, Vimeo and Dailymotion.', 'supreme-modules-for-divi' ),
				'default_on_front' => 'off',
				'show_if'          => array(
					'button_one_url_type' => 'url',
				),
			...
			'button_one_tooltip'                 => array(
				...
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'description'      => esc_html__( 'This will show a tooltip on your Button #1.', 'supreme-modules-for-divi' ),
				'default_on_front' => 'off',
			),
			'button_one_tooltip_content'         => array(
				'label'            => esc_html__( 'Tooltip Content', 'supreme-modules-for-divi' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the content for the your tooltip.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
			...
			'button_one_tooltip_arrow'           => array(
				'label'            => esc_html__( 'Show Arrow', 'supreme-modules-for-divi' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
					'off' => esc_html__( 'No', 'supreme-modules-for-divi' ),
				...
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'description'      => esc_html__( 'If enable, then an arrow will be added to the tooltip.', 'supreme-modules-for-divi' ),
				'default_on_front' => 'on',
				'show_if'          => array(
					'button_one_tooltip' => 'on',
				),
			...
			'button_one_tooltip_size'            => array(
				...
				'option_category'  => 'configuration',
				'options'          => array(
					'small'   => esc_html__( 'Small', 'supreme-modules-for-divi' ),
					'regular' => esc_html__( 'Regular', 'supreme-modules-for-divi' ),
					'large'   => esc_html__( 'Large', 'supreme-modules-for-divi' ),
				),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				...
				'description'      => esc_html__( 'The size of the tooltip.', 'supreme-modules-for-divi' ),
			),
			...
			'button_one_tooltip_animation'       => array(
				'label'            => esc_html__( 'Animations', 'supreme-modules-for-divi' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => $dsm_animation_type_list,
				'default'          => 'fade',
				'default_on_front' => 'fade',
				'description'      => esc_html__( 'Here you can choose different types of animations for your tooltips.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_one_tab',
				'show_if'          => array(
					'button_one_tooltip' => 'on',
			...
			'button_one_tooltip_distance' => array(
				'label'             => esc_html__( 'Distance', 'supreme-modules-for-divi' ),
				'type'              => 'range',
			...
			'button_two_text'                    => array(
				'label'           => esc_html__( 'Button #2 Text', 'supreme-modules-for-divi' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Enter the text for the Button.', 'supreme-modules-for-divi' ),
				'toggle_slug'     => 'main_content',
			...
			'button_two_url_type'                => array(
				'label'            => esc_html__( 'Link Type for Button #2', 'supreme-modules-for-divi' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => array(
					'url'          => esc_html__( 'URL Link', 'supreme-modules-for-divi' ),
			...
			'button_two_email_address'           => array(
				'label'            => sprintf( esc_html__( 'Email', 'supreme-modules-for-divi' ), '#2' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the Email Address for Button #2.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_two_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_two_email_cc'                => array(
				'label'            => sprintf( esc_html__( 'CC', 'supreme-modules-for-divi' ), '#2' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the carbon copy email address for Button #2.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_two_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_two_email_bcc'               => array(
				'label'            => sprintf( esc_html__( 'BCC', 'supreme-modules-for-divi' ), '#2' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the blind carbon copy email address for Button #2.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_two_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_two_email_subject'           => array(
				'label'           => sprintf( esc_html__( 'Subject', 'supreme-modules-for-divi' ), '#2' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Enter the default subject of the email for Button #1.', 'supreme-modules-for-divi' ),
				'toggle_slug'     => 'links',
			...
			'button_two_email_msg'               => array(
				'label'            => sprintf( esc_html__( 'Message', 'supreme-modules-for-divi' ), '#2' ),
				'type'             => 'textarea',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the default body message of the email for Button #2.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_two_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_two_phone_number'            => array(
				'label'            => sprintf( esc_html__( 'Phone Number', 'supreme-modules-for-divi' ), '#2' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the phone number to call for Button #1 (This will usually work on mobile phones)', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
			...
			'button_two_sms_body_text'           => array(
				'label'            => sprintf( esc_html__( 'Body Text', 'supreme-modules-for-divi' ), '#2' ),
				'type'             => 'textarea',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Pre-Populate SMS Text for Button #2 (This will usually work on mobile phones)', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_two_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_two_fb_messenger'            => array(
				'label'            => sprintf( esc_html__( 'Username', 'supreme-modules-for-divi' ), '#2' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter a person, page, or bot username.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
			...
			'button_two_skype'                   => array(
				...
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the Skype username for Button #2.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_two_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_two_whatsapp_number'         => array(
				'label'            => sprintf( esc_html__( 'Number', 'supreme-modules-for-divi' ), '#2' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the phone number to message directly via WhatsApp message for Button #2.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_two_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_two_whatsapp_msg'            => array(
				...
				'type'             => 'textarea',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the default body message of the WhatsApp for Button #2.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_two_tab',
				'default_on_front' => '',
				'show_if'          => array(
			...
			'button_two_telegram'                => array(
				'label'            => sprintf( esc_html__( 'Telegram Username', 'supreme-modules-for-divi' ), '#2' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the Telegram Username.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'links',
			...
			'button_two_url'                     => array(
				'label'           => esc_html__( 'Button #2 URL', 'supreme-modules-for-divi' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Enter the URL for the Button.', 'supreme-modules-for-divi' ),
				'toggle_slug'     => 'links',
			...
			'button_two_video_popup'             => array(
				...
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_two_tab',
				'description'      => esc_html__( 'Put the Video link on the Button #2 URL. Copy the video URL link and paste it here. Support: YouTube, Vimeo and Dailymotion.', 'supreme-modules-for-divi' ),
				'default_on_front' => 'off',
				'show_if'          => array(
					'button_two_url_type' => 'url',
				),
			...
			'button_two_tooltip'                 => array(
				...
				'toggle_slug'      => 'links',
				'sub_toggle'       => 'button_two_tab',
				'description'      => esc_html__( 'This will show a tooltip on your Button #2.', 'supreme-modules-for-divi' ),
				'default_on_front' => 'off',
			),
			...
			'separator_text'                     => array(
				'label'           => esc_html__( 'Separator Text', 'supreme-modules-for-divi' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Input your desired seprator text, or leave blank for no separator text in between the both buttons.', 'supreme-modules-for-divi' ),
				'toggle_slug'     => 'separator',
				'dynamic_content' => 'text',
			),
			'fullwidth_separator_text_on_mobile' => array(
				'label'            => esc_html__( 'Make Separator Text Fullwidth On Mobile', 'supreme-modules-for-divi' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
					'off' => esc_html__( 'No', 'supreme-modules-for-divi' ),
				...
				'toggle_slug'      => 'separator',
				'description'      => esc_html__( 'This will make the Separator Text as fullwidth instead of inline-block.', 'supreme-modules-for-divi' ),
				'default_on_front' => 'off',
				'show_if'          => array(
			...
			'remove_separator_text_on_mobile'    => array(
				'label'            => esc_html__( 'Remove Separator Text On Mobile', 'supreme-modules-for-divi' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
					'off' => esc_html__( 'No', 'supreme-modules-for-divi' ),
				...
				'toggle_slug'      => 'separator',
				'description'      => esc_html__( 'This will remove Separator Text on mobile devices.', 'supreme-modules-for-divi' ),
				'default_on_front' => 'off',
			),
			'separator_gap'                      => array(
				'label'           => esc_html__( 'Text Separator Gap', 'supreme-modules-for-divi' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'tab_slug'        => 'advanced',
				'mobile_options'  => true,
			...
			'button_one_hover_animation'         => array(
				'label'            => esc_html__( 'Button Hover #1 Animation', 'supreme-modules-for-divi' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => array(
					'dsm-none'                   => esc_html__( 'None', 'supreme-modules-for-divi' ),
					'dsm-grow'                   => esc_html__( 'Grow', 'supreme-modules-for-divi' ),
					'dsm-grow-rotate'            => esc_html__( 'Grow Rotate', 'supreme-modules-for-divi' ),
					'dsm-shrink'                 => esc_html__( 'Shrink', 'supreme-modules-for-divi' ),
					'dsm-pulse'                  => esc_html__( 'Pulse', 'supreme-modules-for-divi' ),
					'dsm-pulse-grow'             => esc_html__( 'Pulse Grow', 'supreme-modules-for-divi' ),
					'dsm-pulse-shrink'           => esc_html__( 'Pulse Shrink', 'supreme-modules-for-divi' ),
					'dsm-push'                   => esc_html__( 'Push', 'supreme-modules-for-divi' ),
					'dsm-pop'                    => esc_html__( 'Pop', 'supreme-modules-for-divi' ),
					'dsm-bounce-in'              => esc_html__( 'Bounce In', 'supreme-modules-for-divi' ),
					'dsm-bounce-out'             => esc_html__( 'Bounce Out', 'supreme-modules-for-divi' ),
					'dsm-rotate'                 => esc_html__( 'Rotate', 'supreme-modules-for-divi' ),
					'dsm-float'                  => esc_html__( 'Float', 'supreme-modules-for-divi' ),
					'dsm-sink'                   => esc_html__( 'Sink', 'supreme-modules-for-divi' ),
					'dsm-bob'                    => esc_html__( 'Bob', 'supreme-modules-for-divi' ),
					'dsm-hang'                   => esc_html__( 'Hang', 'supreme-modules-for-divi' ),
					'dsm-skew'                   => esc_html__( 'Skew', 'supreme-modules-for-divi' ),
					'dsm-skew-forward'           => esc_html__( 'Skew Forward', 'supreme-modules-for-divi' ),
					'dsm-skew-backward'          => esc_html__( 'Skew Backward', 'supreme-modules-for-divi' ),
					'dsm-wobble-vertical'        => esc_html__( 'Wobble Vertical', 'supreme-modules-for-divi' ),
					'dsm-wobble-horizontal'      => esc_html__( 'Wobble Horizontal', 'supreme-modules-for-divi' ),
					'dsm-wobble-to-bottom-right' => esc_html__( 'Wobble to Bottom Right', 'supreme-modules-for-divi' ),
					'dsm-wobble-to-top-right'    => esc_html__( 'Wobble to Top Right', 'supreme-modules-for-divi' ),
					'dsm-wobble-top'             => esc_html__( 'Wobble Top', 'supreme-modules-for-divi' ),
					'dsm-wobble-bottom'          => esc_html__( 'Wobble Bottom', 'supreme-modules-for-divi' ),
					'dsm-wobble-skew'            => esc_html__( 'Wobble Skew', 'supreme-modules-for-divi' ),
					'dsm-buzz'                   => esc_html__( 'Buzz', 'supreme-modules-for-divi' ),
					'dsm-buzz-out'               => esc_html__( 'Buzz Out', 'supreme-modules-for-divi' ),
					'dsm-forward'                => esc_html__( 'Forward', 'supreme-modules-for-divi' ),
					'dsm-backward'               => esc_html__( 'Backward', 'supreme-modules-for-divi' ),
				),
				'tab_slug'         => 'advanced',
			...
			'button_one_icon_hover_animation'    => array(
				'label'            => esc_html__( 'Button Icon Hover #1 Animation', 'supreme-modules-for-divi' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => array(
					'dsm-icon-none'         => esc_html__( 'None', 'supreme-modules-for-divi' ),
					'dsm-icon-back'         => esc_html__( 'Back', 'supreme-modules-for-divi' ),
					'dsm-icon-forward'      => esc_html__( 'Forward', 'supreme-modules-for-divi' ),
					'dsm-icon-down'         => esc_html__( 'Down', 'supreme-modules-for-divi' ),
					'dsm-icon-up'           => esc_html__( 'Up', 'supreme-modules-for-divi' ),
					'dsm-icon-spin'         => esc_html__( 'Spin', 'supreme-modules-for-divi' ),
					'dsm-icon-float-away'   => esc_html__( 'Float Away', 'supreme-modules-for-divi' ),
					'dsm-icon-sink-away'    => esc_html__( 'Sink Away', 'supreme-modules-for-divi' ),
					'dsm-icon-grow'         => esc_html__( 'Grow', 'supreme-modules-for-divi' ),
					'dsm-icon-shrink'       => esc_html__( 'Shrink', 'supreme-modules-for-divi' ),
					'dsm-icon-pulse'        => esc_html__( 'Pulse', 'supreme-modules-for-divi' ),
					'dsm-icon-pulse-grow'   => esc_html__( 'Pulse Grow', 'supreme-modules-for-divi' ),
					'dsm-icon-pulse-shrink' => esc_html__( 'Pulse Shrink', 'supreme-modules-for-divi' ),
					'dsm-icon-push'         => esc_html__( 'Push', 'supreme-modules-for-divi' ),
					'dsm-icon-pop'          => esc_html__( 'Pop', 'supreme-modules-for-divi' ),
					'dsm-icon-bounce'       => esc_html__( 'Bounce', 'supreme-modules-for-divi' ),
				),
				'tab_slug'         => 'advanced',
				'toggle_slug'      => 'animation',
			...
			'button_two_hover_animation'         => array(
				'label'            => esc_html__( 'Button Hover #2 Animation', 'supreme-modules-for-divi' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => array(
					'dsm-none'                   => esc_html__( 'None', 'supreme-modules-for-divi' ),
			...
			'button_two_icon_hover_animation'    => array(
				'label'            => esc_html__( 'Button Icon Hover #2 Animation', 'supreme-modules-for-divi' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => array(
					'dsm-icon-none'         => esc_html__( 'None', 'supreme-modules-for-divi' ),
