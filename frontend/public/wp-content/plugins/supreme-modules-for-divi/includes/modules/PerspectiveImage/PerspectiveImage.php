...
class DSM_Perspective_Image extends ET_Builder_Module {
	...
	public function init() {
		$this->name      = esc_html__( 'Supreme Image', 'supreme-modules-for-divi' );
		$this->plural    = esc_html__( 'Supreme Images', 'supreme-modules-for-divi' );
		$this->icon_path = plugin_dir_path( __FILE__ ) . 'icon.svg';

		$this->settings_modal_toggles = array(
			'general'    => array(
				'toggles' => array(
					'main_content' => esc_html__( 'Image', 'supreme-modules-for-divi' ),
					'link'         => esc_html__( 'Link', 'supreme-modules-for-divi' ),
					'transform'    => esc_html__( 'Transform & Rotation', 'supreme-modules-for-divi' ),
				),
			),
			'advanced'   => array(
				'toggles' => array(
					'overlay'   => esc_html__( 'Overlay', 'supreme-modules-for-divi' ),
					'lightbox'  => esc_html__( 'Lightbox', 'supreme-modules-for-divi' ),
			...
			'custom_css' => array(
				'toggles' => array(
					'animation'  => array(
						'title'    => esc_html__( 'Animation', 'supreme-modules-for-divi' ),
						'priority' => 90,
					),
					'attributes' => array(
		...
		return array(
			...
			'borders'        => array(
				...
				'overlay' => array(
					...
					'label_prefix'    => esc_html__( 'Overlay', 'supreme-modules-for-divi' ),
					'tab_slug'        => 'advanced',
					'toggle_slug'     => 'overlay',
	...
	public function get_fields() {
		return array(
			'src'                         => array(
				...
				'description'        => esc_html__( 'Upload your desired image, or type in the URL to the image you would like to display.', 'supreme-modules-for-divi' ),
				'toggle_slug'        => 'main_content',
				'dynamic_content'    => 'image',
			),
			'alt'                         => array(
				'label'           => esc_html__( 'Image Alternative Text', 'supreme-modules-for-divi' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'depends_show_if' => 'on',
				'depends_on'      => array(
				...
				'description'     => esc_html__( 'This defines the HTML ALT text. A short description of your image can be placed here.', 'supreme-modules-for-divi' ),
				'tab_slug'        => 'custom_css',
				'toggle_slug'     => 'attributes',
				'dynamic_content' => 'text',
			),
			'title_text'                  => array(
				'label'           => esc_html__( 'Image Title Text', 'supreme-modules-for-divi' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'depends_show_if' => 'on',
				'depends_on'      => array(
				...
				'description'     => esc_html__( 'This defines the HTML Title text.', 'supreme-modules-for-divi' ),
				'tab_slug'        => 'custom_css',
				'toggle_slug'     => 'attributes',
				'dynamic_content' => 'text',
			),
			'show_in_lightbox'            => array(
				'label'            => esc_html__( 'Open in Lightbox', 'supreme-modules-for-divi' ),
				'type'             => 'yes_no_button',
				...
				'toggle_slug'      => 'link',
				'description'      => esc_html__( 'Here you can choose whether or not the image should open in Lightbox. Note: if you select to open the image in Lightbox, url options below will be ignored.', 'supreme-modules-for-divi' ),
			),
			'show_lightbox_other_img'     => array(
				'label'            => esc_html__( 'Use Other Lightbox Image', 'supreme-modules-for-divi' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
					'off' => esc_html__( 'No', 'supreme-modules-for-divi' ),
				...
				'toggle_slug'      => 'link',
				'description'      => esc_html__( 'Here you can choose whether you want to have another image should open in Lightbox.', 'supreme-modules-for-divi' ),
			),
			'show_lightbox_other_img_src' => array(
				'type'               => 'upload',
				'option_category'    => 'basic_option',
				'upload_button_text' => esc_attr__( 'Upload an Lightbox image', 'supreme-modules-for-divi' ),
				'choose_text'        => esc_attr__( 'Choose an Lightbox Image', 'supreme-modules-for-divi' ),
				'update_text'        => esc_attr__( 'Set As Lightbox Image', 'supreme-modules-for-divi' ),
				'hide_metadata'      => true,
				'description'        => esc_html__( 'Upload your desired image, or type in the URL to the image you would like to display.', 'supreme-modules-for-divi' ),
				'toggle_slug'        => 'link',
				'dynamic_content'    => 'image',
			...
			'url'                         => array(
				'label'           => esc_html__( 'Image Link URL', 'supreme-modules-for-divi' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'depends_show_if' => 'off',
				'description'     => esc_html__( 'If you would like your image to be a link, input your destination URL here. No link will be created if this field is left blank.', 'supreme-modules-for-divi' ),
				'toggle_slug'     => 'link',
				'dynamic_content' => 'url',
			),
			'url_new_window'              => array(
				'label'            => esc_html__( 'Image Link Target', 'supreme-modules-for-divi' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => array(
			...
			'use_video_popup'             => array(
				'label'            => esc_html__( 'Use as Video Popup', 'supreme-modules-for-divi' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
					'off' => esc_html__( 'No', 'supreme-modules-for-divi' ),
				...
				'toggle_slug'      => 'link',
				'description'      => esc_html__( 'Put the Video link on the Image URL. Copy the video URL link and paste it here. Support: YouTube, Vimeo and Dailymotion.', 'supreme-modules-for-divi' ),
				'default_on_front' => 'off',
				'show_if_not'      => array(
					'show_in_lightbox' => 'on',
				),
			...
			'perspective'                 => array(
				'label'            => esc_html__( 'Perspective', 'supreme-modules-for-divi' ),
				'type'             => 'range',
			...
			'dsm_rotate_y'                => array(
				'label'            => esc_html__( 'Rotate Y', 'supreme-modules-for-divi' ),
				'type'             => 'range',
				'option_category'  => 'layout',
				'toggle_slug'      => 'transform',
				// 'mobile_options'  => true,
			...
			'dsm_rotate_x'                => array(
				'label'            => esc_html__( 'Rotate X', 'supreme-modules-for-divi' ),
				'type'             => 'range',
				'option_category'  => 'layout',
				'toggle_slug'      => 'transform',
				// 'mobile_options'  => true,
			...
			'dsm_rotate_z'                => array(
				'label'            => esc_html__( 'Rotate Z', 'supreme-modules-for-divi' ),
				'type'             => 'range',
				'option_category'  => 'layout',
				'toggle_slug'      => 'transform',
				// 'mobile_options'  => true,
			...
			'use_overlay'                 => array(
				'label'            => esc_html__( 'Image Overlay', 'supreme-modules-for-divi' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'layout',
				'options'          => array(
					'off' => esc_html__( 'Off', 'supreme-modules-for-divi' ),
					'on'  => esc_html__( 'On', 'supreme-modules-for-divi' ),
				),
				'default_on_front' => 'off',
				'affects'          => array(
				...
				'tab_slug'         => 'advanced',
				'toggle_slug'      => 'overlay',
				'description'      => esc_html__( 'If enabled, an overlay color and icon will be displayed when a visitors hovers over the image', 'supreme-modules-for-divi' ),
			),
			'hover_overlay_color'         => array(
				...
				'tab_slug'        => 'advanced',
				'toggle_slug'     => 'overlay',
				'description'     => esc_html__( 'Here you can define a custom color for the overlay', 'supreme-modules-for-divi' ),
			),
			'use_icon'                    => array(
				...
				'description'      => esc_html__( 'If enabled, icon will only show up.', 'supreme-modules-for-divi' ),
			),
			'overlay_icon_color'          => array(
				'label'           => esc_html__( 'Overlay Icon Color', 'supreme-modules-for-divi' ),
				'type'            => 'color-alpha',
				'custom_color'    => true,
				'depends_show_if' => 'on',
				'tab_slug'        => 'advanced',
				'toggle_slug'     => 'overlay',
				'description'     => esc_html__( 'Here you can define a custom color for the overlay icon', 'supreme-modules-for-divi' ),
			),
			'hover_icon'                  => array(
				'label'           => esc_html__( 'Icon Picker', 'supreme-modules-for-divi' ),
				'type'            => 'select_icon',
				'option_category' => 'configuration',
				'default'         => 'P',
				...
				'tab_slug'        => 'advanced',
				'toggle_slug'     => 'overlay',
				'description'     => esc_html__( 'Here you can define a custom icon for the overlay', 'supreme-modules-for-divi' ),
			),
			'overlay_on_hover'            => array(
				'label'            => esc_html__( 'Show Overlay On Hover', 'supreme-modules-for-divi' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'layout',
				'options'          => array(
					'off' => esc_html__( 'Off', 'supreme-modules-for-divi' ),
				...
				'tab_slug'         => 'advanced',
				'toggle_slug'      => 'overlay',
				'description'      => esc_html__( 'If enabled, overlay will only show on hover.', 'supreme-modules-for-divi' ),
			),
			'align'                       => array(
				'label'            => esc_html__( 'Image Alignment', 'supreme-modules-for-divi' ),
				'type'             => 'text_align',
				'option_category'  => 'layout',
				...
				'description'      => esc_html__( 'Here you can choose the image alignment.', 'supreme-modules-for-divi' ),
				'options_icon'     => 'module_align',
			),
			'force_fullwidth'             => array(
				'label'            => esc_html__( 'Force Fullwidth', 'supreme-modules-for-divi' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'layout',
				'options'          => array(
					'off' => esc_html__( 'No', 'supreme-modules-for-divi' ),
			...
			'always_center_on_mobile'     => array(
				'label'            => esc_html__( 'Always Center Image On Mobile', 'supreme-modules-for-divi' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'layout',
				'options'          => array(
					'on'  => esc_html__( 'Yes', 'supreme-modules-for-divi' ),
