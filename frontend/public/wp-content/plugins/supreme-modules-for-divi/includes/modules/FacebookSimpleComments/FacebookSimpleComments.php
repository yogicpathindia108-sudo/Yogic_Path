...
class DSM_FacebookSimpleComments extends ET_Builder_Module {
	...
	public function init() {
		$this->name      = esc_html__( 'Supreme Facebook Comments', 'supreme-modules-for-divi' );
		$this->icon_path = plugin_dir_path( __FILE__ ) . 'icon.svg';
		// Toggle settings
		$this->settings_modal_toggles = array(
			'general'  => array(
				'toggles' => array(
					'main_content' => esc_html__( 'Facebook Comments Settings', 'supreme-modules-for-divi' ),
				),
			),
			'advanced' => array(
				'toggles' => array(),
	...
	public function get_fields() {
		return array(
			...
			'fb_app_id'        => array(
				...
				'description'      => et_get_safe_localization( sprintf( /* translators: URL Link of Facebook Developer */ __( 'The Facebook module uses the Facebook APP ID and requires a Facebook APP ID to function. Before using all Facebook module, please make sure you have added your Facebook APP ID inside the Divi Supreme Plugin Page. You can go to <a href="%1$s">Facebook Developer</a> and click on Create New App to get one.', 'supreme-modules-for-divi' ), esc_url( 'https://developers.facebook.com/apps/' ) ) ),
				'toggle_slug'      => 'main_content',
			),
			'page_url'         => array(
				'label'            => esc_html__( 'Page URL', 'supreme-modules-for-divi' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'description'      => esc_html__( 'Enter the Page URL.', 'supreme-modules-for-divi' ),
				'toggle_slug'      => 'main_content',
				'default_on_front' => 'https://www.facebook.com/divisupreme/',
				'dynamic_content'  => 'url',
			),
			'num_posts'        => array(
				'label'            => esc_html__( 'Number of Posts', 'supreme-modules-for-divi' ),
				'type'             => 'text',
				'option_category'  => 'basic_option',
				'toggle_slug'      => 'main_content',
				'description'      => esc_html__( 'The number of comments to show by default. The minimum value is 1.', 'supreme-modules-for-divi' ),
				'default_on_front' => '10',
				'dynamic_content'  => 'text',
			),
			'color_scheme'     => array(
				'label'            => esc_html__( 'Color Scheme', 'supreme-modules-for-divi' ),
				'type'             => 'select',
				...
				'toggle_slug'      => 'main_content',
				'description'      => esc_html__( 'The color scheme used by the comments plugin. Can be "light" or "dark".', 'supreme-modules-for-divi' ),
				'default_on_front' => 'light',
			),
			'order_by'         => array(
				'label'            => esc_html__( 'Order By', 'supreme-modules-for-divi' ),
				'type'             => 'select',
				'option_category'  => 'configuration',
				'options'          => array(
					'social'       => esc_html__( 'Social', 'supreme-modules-for-divi' ),
					'reverse_time' => esc_html__( 'Reverse Time', 'supreme-modules-for-divi' ),
					'time'         => esc_html__( 'Time', 'supreme-modules-for-divi' ),
				),
				'toggle_slug'      => 'main_content',
				'description'      => sprintf( /* translators: Link of Facebook Docs */ esc_html__( 'The order to use when displaying comments. Can be "social", "reverse_time", or "time". The different order types are explained <a href="%1$s">in the FAQ</a>', 'supreme-modules-for-divi' ), 'https://developers.facebook.com/docs/plugins/comments/#faqorder', 'supreme-modules-for-divi' ),
