...
<li class="<?php echo esc_attr( $class ); ?>">
	...
	<label for="payment_method_<?php echo esc_attr( $gateway->id ); ?>">
		<?php echo $gateway->get_title(); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Set by WooCommerce plugin */ ?> <?php echo $gateway->get_icon(); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Set by WooCommerce plugin */ ?>
	</label>
