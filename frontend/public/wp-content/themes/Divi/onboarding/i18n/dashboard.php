...
return [
	...
	'Upgrade to Divi 5'                              => esc_html__( 'Upgrade to Divi 5', 'Divi' ),
	'Switch to Divi 5 updates to receive ...'        => esc_html__( 'We started over and completely reinvented Divi, focusing on performance and advanced design systems. Divi 5 is fast, lean, and packed with modern features to lead the next generation of page builders. If you want to switch to Divi 5, you can click the button below to enable Divi 5 updates. Before you do, we recommend learning about', 'Divi' ),
	'Divi 5\'s new features'                         => __( 'Divi 5\'s new features', 'Divi' ),
	'and familiarizing yourself with'                => esc_html__( 'and familiarizing yourself with', 'Divi' ),
	'the migration process'                          => esc_html__( 'the migration process', 'Divi' ),
	'.'                                              => esc_html__( '. Divi 5 represents a significant change, and we always recommend testing major updates on a staging site first.', 'Divi' ),
	'Enable Divi 5 Updates'                          => esc_html__( 'Enable Divi 5 Updates', 'Divi' ),
	'Switching...'                                   => esc_html__( 'Switching...', 'Divi' ),
	'Learn About Divi 5'                             => esc_html__( 'Learn About Divi 5', 'Divi' ),
	'You are receiving Divi 5 updates ...'           => esc_html__( 'You have switched to the Divi 5 upgrade path and are now receiving Divi 5 updates. Visit the WordPress updates page to check for updates.', 'Divi' ),
	'Check for Updates'                              => esc_html__( 'Check for Updates', 'Divi' ),
	'Disable Divi 5 Updates'                         => esc_html__( 'Disable Divi 5 Updates', 'Divi' ),
	'Disabling...'                                   => esc_html__( 'Disabling...', 'Divi' ),
];
